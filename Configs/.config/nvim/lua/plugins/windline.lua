return {
	...
	config = function()
		vim.api.nvim_create_autocmd("VimEnter", {
			callback = function()
				vim.cmd('lua require("windline.components.cava").toggle()')
			end,
		})
		...
		airline_colors.a = {
			NormalSep = { "magenta_c", "magenta_b" },
			InsertSep = { "green_c", "green_b" },
			VisualSep = { "yellow_c", "yellow_b" },
			ReplaceSep = { "blue_c", "blue_b" },
			CommandSep = { "red_c", "red_b" },
		...
		airline_colors.b = {
			NormalSep = { "magenta_b", "magenta_a" },
			InsertSep = { "green_b", "green_a" },
			VisualSep = { "yellow_b", "yellow_a" },
			ReplaceSep = { "blue_b", "blue_a" },
			CommandSep = { "red_b", "red_a" },
		...
		airline_colors.c = {
			NormalSep = { "magenta_a", "NormalBg" },
			InsertSep = { "green_a", "NormalBg" },
			VisualSep = { "yellow_a", "NormalBg" },
			ReplaceSep = { "blue_a", "NormalBg" },
			CommandSep = { "red_a", "NormalBg" },
